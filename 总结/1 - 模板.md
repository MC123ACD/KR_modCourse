...
| 英雄                       | 模板名                   | 一技能   |                             | 二技能   |                          | 三技能   |                                  | 四技能   |                                  | 五技能/终极技能 | 技能代码                              | 被动技能  | 技能代码                           |
| :----------------------- | :-------------------- | :---- | :-------------------------- | :---- | :----------------------- | :---- | :------------------------------- | :---- | :------------------------------- | :------- | :-------------------------------- | :---- | :----------------------------- |
| **维鲁克**                  | `hero_veruk`          | 瞄准砍击  | `hero_orc_aimedslashes`     | 蛮力    | `hero_orc_bruteforce`    | 决斗    | `warmonger_hero_orc_extra_melee` | 振臂一呼  | `inspiring_leader`               | 哥布林投矛手   | `reinforcement_warmongers_goblin` | 兽人血统  | `warlust`                      |
| **阿斯拉**                  | `hero_asra`           | 蜘蛛啮   | `spider_bite`               | 岩蛇箭   | `onix_arrows`            | 哀恸箭袋  | `skill_damage_armor`             | 暗影之盾  | `shield_of_shadows`              | 毒箭雨      | `ultimate_hero_asra`              | 暗影之舞  | `shadow_dance_teleport`        |
| **奥洛克**                  | `hero_oloch`          | 自我复制  | `duplication`               | 岩浆喷发  | `magma_eruption`         | 地狱注入  | `hellish_infusion`               | 恶魔飞爆  | `demonic_blast`                  | 孤立缄印     | `ultimate_hero_oloch`             | 炼狱业火  | `infernal_combustion`          |
| **苦楝夫人**                 | `hero_margosa`        | 熟吸蝙蝠  | `bat_familiar`              | 绝望迷雾  | `myst_form`              | 黑暗召唤  | `dark_call`                      | 吸血鬼之触 | `modifier_healing_self_disabled` | 野兽形态     | `beast_melee`                     | 蝙蝠形态  | `special_walk`                 |
| **墨尔弥斯**                 | `hero_mortemis`       | 夜鬼哭   | `call_of_the_haunted`       | 腐朽之地  | `deadly_fumes`           | 无望之人  | `grim_presence`                  | 不死人之奴 | `undead_servitude`               | 腐朽近卫     | `hero_mortemis_zombie_ultimate`   | 黑暗军团  | `army_of_darkness`             |
| **特拉敏**                  | `hero_tramin`         | 自爆机器人 | `hero_tramin_bombots`       | 饮硝狂奔  | `nitro_rush`             | 闪光弹   | `flashbang`                      | 火箭弹幕  | `rocket_barrage`                 | 疯狂炸弹人    | `ultimate_hero_tramin`            | 火箭跳跃  | `launch_movement`              |
| **极狗**                   | `hero_jigou`          | 雪球    | `ice_shard`                 | 霜冻吐息  | `frozen_breath`          | 猛击地球  | `jigou_earthshake`               | 冰川形态  | `glacial_form`                   | 冰区       | `ultimate_hero_jigou`             | 雪人血统  | `regeneration_passive`         |
| **黑龙**                   | `hero_beresad`        | 绿焰    | `conflagration`             | 惧龙    | `fear_dragon`            | 龙生傀儡  | `dragon_spawn`                   | 片甲不留  | `remove_existence`               | 地狱火      | `ultimate_hero_beresad`           | 金之欲   | `goldlust`                     |
| **坦克**                   | `hero_tank`           | 热感飞弹  | `heat_missiles`             | 地震波   | `ground_slam`            | 敢死队   | `expendables`                    | 灼热大炮  | `scorching_cannon`               | 女武神的召唤   | `ultimate_hero_tank`              | 多刺蛞蝓  | `spiky_slugs`                  |
| **浚湃**                   | `hero_naga`           | 潮汐    | `tidal_wave`                | 勇气旗帜  | `banner_courage`         | 娜迦之凝视 | `gaze_of_the_naga`               | 水花四溅  | `tri_splash`                     | 深渊召唤     | `ultimate_hero_naga`              | 背水一战  | `last_stand`                   |
| **冰龙**                   | `hero_eiskalt`        | 暴烈之息  | `damage_area_fierce_breath` | 永恒冻土  | `eiskalt_cold_fury`      | 雪崩    | `hero_eiskalt_ice_ball`          | 冰峰    | `eiskalt_ice_peaks`              | 冰川风暴     | `ultimate_hero_eiskalt`           | 寒冰吐息  | `eiskalt_frozen_throat_slow`   |
| **火龙**                   | `hero_murglun`        | 熔岩池   | `decal_magma_pool`          | 焦油制造者 | `tar_maker`              | 火山爆发  | `murglun_geyser`                 | 炼狱之炎  | `murglun_infernal_heat`          | 火山爆发(终极) | `ultimate_hero_murglun`           | 岩浆血   | `murglun_passive`              |
| **南瓜杰克**                 | `hero_jack_o_lantern` | 爆炸头   | `explosive_head`            | 鬼缠之刃  | `haunted_blade`          | 复仇之灵  | `accumulated_damage_factor`      | 惊魂夜   | `hero_jacko_thriller`            | 噩梦骑兵     | `ultimate_hero_jacko`             | 幽魂骑士  | `hero_jack_o_lantern_teleport` |
| **电云**                   | `hero_dianyun`        | 闪电打击  | `range_dinayun_ricochet`    | 暴风领主  | `max_targets_lord_storm` | 神圣雨露  | `dianyun_divine_rain`            | 至尊波   | `supreme_wave`                   | 雷电之子     | `ultimate_hero_dianyun`           | 孔明灯   | `dianyun_passive`              |
| **格罗什**                  | `hero_mammoth`        | 裂隙重斩  | `ancestral_force`           | 无尽的愤怒 | `frenzy`                 | 利刃狂风  | `whirlwind`                      | 远古遗恨  | `legacy`                         | 骸骨之浪     | `ultimate_hero_mammoth`           | 独狼    | `lone_wolf`                    |
| **伊斯菲特**                 | `hero_isfet`          | 黑色蝗灾  | `black_cloud`               | 青蛙诅咒  | `frog_curse`             | 冰火雨   | `rain_of_fire_ice`               | 血池    | `blood_pool`                     | (终极技能)   | `ultimate_hero_isfet`             | 木乃伊仆从 | `hero_isfet_mummy`             |
| **卢塞尔娜**                 | `hero_lucerna`        | 坏血骇颜  | `group_hero_lucerna_scare`  | 幽蓝弹幕  | `pop_kaboom`             | 诅咒船员  | `lucerna_spawn_units`            | 赏金炮弹  | `give_gold`                      | 厄咒战旗     | `ultimate_hero_lucerna`           | 移形换步  | `hero_lucerna_teleport`        |
| ........................ |                       |       |                             |       |                          |       |                                  |       |                                  |          |                                   |       |                                |
