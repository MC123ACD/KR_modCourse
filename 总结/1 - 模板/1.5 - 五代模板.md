...
|   **恶视魔塔**    | 第 15 关              | `stage15_cult_leader_tower`    |    **木龙魂**    | 第 31 关              | `tower_holder_blocked_elemental_wood`  |
|   **全视之慧眼**   | 第 16 关              | `stage16_overseer`             |   **减速喷泉**    | 第 31 关              | `controller_stage_31_water_mechanic`   |
|    **艾莉丹**    | 第 18 关              | `stage18_eridan`               |    **火龙魂**    | 第 32 关              | `tower_holder_blocked_elemental_fire`  |
|    **死灵墓**    | 第 19 关              | `stage19_mausoleum`            |    **水龙魂**    | 第 33 关              | `tower_holder_blocked_elemental_water` |
| **树灵守望者（废案）** | 第 20 关              | `stage_20_arborean_watchtower` |               |                     |                                        |
| **树灵小屋（废案）**  | 第 20 关              | `stage20_arborean_house`       |               |                     |                                        |
|  **落石（废案）**   | 第 21 关              | `stage21_falling_rocks`        |               |                     |                                        |
|               |                     |                                | **树灵贤者（废案）**  |                     | `arborean_sages`                       |
|               |                     |                                |  **果树（废案）**   |                     | `fruity_tree`                          |
|               |                     |                                | **统帅旌旗（废案）**  |                     | `banner_of_command`                    |
|               |                     |                                | **无赦项链（废案）**  |                     | `locket_of_the_unforgiven`             |
|               |                     |                                | **逆反之镜（废案）**  |                     | `mirror_of_inversion`                  |
|               |                     |                                | **守护宝珠（废案）**  |                     | `guardian_orb`                         |
|               |                     |                                | **祝福之锤（废案）**  |                     | `hammer_of_the_blessed`                |
