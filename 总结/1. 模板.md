...
| **boss 红孩儿**  | `boss_redboy_teen`             | **boss 墨尔古伦**  | `boss_murglum`                   |
|    **渔民**     | `enemy_citizen`                |    **暗影幼龙**    | `enemy_basic_shadow`             |
|    **风校尉**    | `enemy_gale_warrior`           |    **永夜魔龙**    | `enemy_alfa_shadow`              |
|   **天雷雏龙**    | `enemy_storm_spirit`           |    **幽影飞龙**    | `enemy_evolved_shadow`           |
|    **水灵精**    | `enemy_water_spirit`           |    **雷暴魔龙**    | `enemy_alfa_storm`               |
|    **怒风怪**    | `enemy_storm_elemental`        |    **风暴飞龙**    | `enemy_evolved_storm`            |
|    **穷奇**     | `enemy_qiongqi`                |    **雷罚龙**     | `enemy_executioner_storm`        |
|    **水长老**    | `enemy_water_sorceress`        |   **魔龙人之母**    | `controller_stage_39_boss`       |
|   **宫廷护卫**    | `enemy_palace_guard`           |   **原初共生体**    | `enemy_miniboss_stage_39`        |
|    **铁扇卫**    | `enemy_fan_guard`              |    **提兰索尔**    | `controller_stage_40_boss`       |
|    **泥俑**     | `enemy_terracota`              |                |                                  |
