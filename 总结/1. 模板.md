...
|    **龙巢**     | `tower_dragons`                               |   魔法唾液   | `dragon_split`     |   颤栗龙吼   | `massive_fear`     |     |            |
|               |                                               |          |                    |          |                    |     |            |
...
|   **守望大法师**   | `tower_dragons_warden`                        | **能量灌注** | `increase_damage`  | **魔力狂暴** | `increase_rate`    |     |            |
|    **龙骑兵**    | `soldier_dragon_warden_dragon_raider_mounted` |          |                    |          |                    |     |            |
| **龙骑兵（没有骑龙）** | `soldier_dragon_warden_dragon_raider`         |          |                    |          |                    |     |            |
|  **守望战士兵营**   | `stage_37_barrack_dragon_wardens`             |          |                    |          |                    |     |            |
|   **守望战士**    | `soldier_dragon_warden_warrior`               |          |                    |          |                    |     |            |
|   **守望者学士**   | `soldier_warden_stage_40_moving_island"`      |          |                    |          |                    |     |            |
...
|  **魔芋爽**  | `hero_lava`          | 暴怒猛击 | `temper_tantrum`    | 起床气  | `hotheaded`       | 双倍麻烦 | `double_trouble`    | 狂野喷发 | `wild_eruption`       |     |
...
|  **日龙**   | `hero_dragon_sun`    | 曜日审判 | `worthy_foe`        | 日耀净化 | `solar_cleansing` | 烈日过载 | `overcharge`        | 日光宝石 | `solar_stones`        |     |
...
|   **米迦尔之女**   | `enemy_spidead`                |                |                                  |
| **boss 米迦尔**  | `boss_spider_queen`            |                |                                  |
|               |                                |                |                                  |
|    **火士卒**    | `enemy_flame_guard`            |    **余烬幼龙**    | `enemy_basic_lava`               |
|    **炎教头**    | `enemy_blaze_raider`           |    **电光幼龙**    | `enemy_basic_storm`              |
|    **火狐精**    | `enemy_fire_fox`               |    **怒锋龙**     | `enemy_tanky_draconian`          |
|    **火凤**     | `enemy_fire_phoenix`           |    **腐源魔龙**    | `enemy_alfa_acid`                |
|   **九尾妖狐**    | `enemy_nine_tailed_fox`        |    **腐蚀飞龙**    | `enemy_evolved_acid`             |
|    **巫仙**     | `enemy_wuxian`                 |    **酸蚀幼龙**    | `enemy_basic_acid`               |
|    **焚树精**    | `enemy_burning_treant`         |    **烈火飞龙**    | `enemy_evolved_lava`             |
|    **悲烬妖**    | `enemy_ash_spirit`             |    **熔岩魔龙**    | `enemy_alfa_lava`                |
| **boss 红孩儿**  | `boss_redboy_teen`             |    **蛮翼龙**     | `enemy_brute_storm`              |
|    **渔民**     | `enemy_citizen`                | **boss 墨尔古伦**  | `boss_murglum`                   |
|    **风校尉**    | `enemy_gale_warrior`           |    **暗影幼龙**    | `enemy_basic_shadow`             |
|   **天雷雏龙**    | `enemy_storm_spirit`           |    **永夜魔龙**    | `enemy_alfa_shadow`              |
|    **水灵精**    | `enemy_water_spirit`           |    **幽影飞龙**    | `enemy_evolved_shadow`           |
|    **怒风怪**    | `enemy_storm_elemental`        |    **雷暴魔龙**    | `enemy_alfa_storm`               |
|    **穷奇**     | `enemy_qiongqi`                |    **风暴飞龙**    | `enemy_evolved_storm`            |
|    **水长老**    | `enemy_water_sorceress`        |    **雷罚龙**     | `enemy_executioner_storm`        |
|   **宫廷护卫**    | `enemy_palace_guard`           |   **魔龙人之母**    | `controller_stage_39_boss`       |
|    **铁扇卫**    | `enemy_fan_guard`              |   **原初共生体**    | `enemy_miniboss_stage_39`        |
|    **泥俑**     | `enemy_terracota`              |    **提兰索尔**    | `controller_stage_40_boss`       |
...
|               |                     |                                 |                    |                     |                                        |
|               |                     |                                 |   **boss 墨尔古伦**    | 第 37 关              | `controller_stage_37_dragon_boss`      |
|               |                     |                                 | **召唤没有骑龙的龙骑兵的传送门** | 第 38 关              | `tower_stage_38_dragon_wardens`        |
|               |                     |                                 |   **使龙骑兵骑上龙的塔**    | 第 38 关              | `tower_stage_38_dragon_wardens_goal`   |
|               |                     |                                 |                    |                     |                                        |
...
#### 1. 创建模板
```lua
E:register_t(模板名: str, 续承模板名?: str) -> 模板的引用: table
```
- 示例：
```lua
...
#### 2. 索引模板
```lua
E:get_template(模板名: str) -> 模板的引用: table
```
...
#### 1. 创建组件
```lua
E:register_c(组件: str) -> 组件的引用: table
```
- **作用**：创建新组件
- 示例：
```lua
...
#### 4. 索引组件
```lua
E:get_component(组件名: str) -> 组件的引用: table
```
